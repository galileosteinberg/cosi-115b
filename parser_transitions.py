...
class PartialParse(object):
    ...
    def __repr__(self):
        return f"PartialParse(Stack: {self.stack}; Buffer: {self.buffer}; Deps: {self.dependencies})"
...
def minibatch_parse(sentences, model, batch_size):
    ...
    while unfinished_parses:
        ...
        transition = model.predict(minibatch)
        for parse, transition in zip(minibatch, transition):
